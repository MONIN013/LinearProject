...
cases = { ...
    "data/plants/4khz/current.mat", 1/4000, 110; ...
    "data/plants/8khz/current.mat", 1/8000, 80};
...
verifyError(testCase, ...
    @()load_experiment_plant(testCase.TestData.repoRoot, ...
        "data/plants/4khz/current.mat", 1/8000), ...
...
verifyTrue(testCase, contains(chirpSource, "save_experiment_plant(runDir, plantResult)"));
end
